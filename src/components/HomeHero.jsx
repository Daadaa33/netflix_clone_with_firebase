    ...
    >
      <header className="flex w-full justify-between">
        ...
        <div className="mx-4 my-6">
          <Link
            to="/SingUp"
            className="rounded font-medium bg-[#e50a14] px-8 py-2 text-white"
          >
            singUp
          </Link>
        </div>
      ...
      <main className="flex flex-1 flex-col items-center justify-center text-center text-white sm:px-20 ">
        ...
        <h2 className="mb-8 mt-4 ">Watch any where , Cancel any time</h2>
        <p className="text-lg ">
        ...
        <div className="m-4 flex flex-col space-y-6  sm:flex-row sm:space-y-0 ">
          <input
            className="w-full min-w-[400px] rounded-bl-sm rounded-tl-sm bg-white px-24  py-4 text-black outline-none sm:p-4"
            type="text"
            placeholder="Enter your Email"
          />
          <button className="flex w-full items-center justify-center rounded-br-sm rounded-tr-sm bg-[#e50914] px-2 py-2 text-lg text-white  sm:px-8 sm:py-0">
            Get Started <AiOutlineRight className="h-8 w-8" />
          </button>
        </div>
      </main>
    </div>
